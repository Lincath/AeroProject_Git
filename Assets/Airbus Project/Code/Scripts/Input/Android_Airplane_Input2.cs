...
{
    public class Android_Airplane_Input2 : Airplane_Input
    {
        ...
        void Update()
        {
            ...
            HandleInput();
            // FAIT AVANCER L'AVION EN LIGNE DROITE
            //transform.Translate(Vector3.forward * Time.deltaTime * stickyThrottle); 
        ...
        {
            //Appelle les inputs claviers
            base.StickyThrottleControl();

            stickyThrottle = 50000f;
        }
